...
type OutgoingMessage = UpdateDataMessage | ErrorMessage | ModelLoadStartedMessage | ModelUnloadedMessage | UpdateSettingsMessage;
...
export class DashboardProvider implements vscode.WebviewViewProvider, vscode.Disposable {
    ...
    async resolveWebviewView(webviewView: vscode.WebviewView): Promise<void> {
        ...
        this.disposables.push(
            webviewView.webview.onDidReceiveMessage((message: WebviewMessage) => this.handleWebviewMessage(message), null)
        );
    ...
    private loadTemplate(): Promise<string> {
        const htmlPath = path.join(this.context.extensionUri.fsPath, 'src', 'webview', 'dashboard.html');
