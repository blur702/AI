...
export function isOllamaTagsResponse(obj: unknown): obj is OllamaTagsResponse {
    ...
    return Array.isArray(obj.models) && obj.models.every((model: unknown) => isOllamaModelInfo(model));
}
...
export function isOllamaPsResponse(obj: unknown): obj is OllamaPsResponse {
    ...
    return Array.isArray(obj.models) && obj.models.every((model: unknown) => isOllamaLoadedModel(model));
}
